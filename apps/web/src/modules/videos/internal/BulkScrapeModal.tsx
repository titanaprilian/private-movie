    ...
    <>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 space-y-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {isConflict && (
                              <span className="mono text-[10px] px-1.5 py-0.5 rounded bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300 font-semibold border border-amber-300 dark:border-amber-700/50">
                                ⚠️ Overwrites existing sources
                              </span>
                            )}
                            {item.isIgnored && (
      ...
      <Dialog open={showOverwriteConfirm} onOpenChange={setShowOverwriteConfirm}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Overwrite Existing Sources?</DialogTitle>
            <DialogDescription>
